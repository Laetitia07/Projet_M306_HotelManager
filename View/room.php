...
if (filter_has_var(INPUT_POST, 'envoyer')) {
    if (isset($_POST['radioAvailable']) && !empty($_POST['radioAvailable'])) {
        $var = $_POST['radioAvailable'];
    }
    $dispos = afficherChambreDispo($var);
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <form action="#" Method="POST">
            ...
            <section id="section2">
                <div id="checkbox">
                    ...
                    <input class="btn btn-light text-dark p-1 mx-5 " type="submit" value="Filtrer" name="envoyer">
                </div>
                <article>
                    ...
                    <div class="list-group" >
                    <?php if (isset($_POST['radioAvailable'])) { ?>
                        <hr>
                        <h2 class="text-center">Chambre <?= $_POST['radioAvailable'] ?></h2>
                        <hr>
                    <?php }
                    foreach ($dispos as $dispo) : ?>
                        <p class="list-group-item list-group-item-action"><?= $dispo['numeroChambre'] . " " . $dispo['type'] . " " . $dispo['telephone'] . " " . $dispo['disponibilite'] ?></p>
                    <?php endforeach; ?>
                    </div>
                </article>
            </section>
